...
class VirtualizedTable extends React.Component {
	...
	_handleMouseMove = (event) => {
		...
		if (event.clientX < parseInt(tgt.dataset.mouseLeft) || event.clientX > parseInt(tgt.dataset.mouseRight)) {
			delete tgt.dataset.mouseLeft;
			delete tgt.dataset.mouseRight;
			delete tgt.dataset.title;
		...
		if (textCell.offsetWidth < textCell.scrollWidth) {
			window.Zotero_Tooltip.stop();
			tgt.dataset.title = textCell.textContent;
			window.Zotero_Tooltip.start(textCell.textContent);
		}
	};
