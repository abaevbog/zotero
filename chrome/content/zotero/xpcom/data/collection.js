...
var properties = {
	...
	isRegularItem: false, // Should be false to prevent items dropped into deleted collections
	isSearch: false,
	getNotes: [],
	getAttachments: [],
...
Zotero.Collection.prototype.getBestAttachment = async () => { return false; };
Zotero.Collection.prototype.getBestAttachments = async () => { return false; };
